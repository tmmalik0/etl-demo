...
class Connector {
        ...
        switch ( $type ) {
          case "swaps":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['id'];
          		$dataRows[] = $row['client'];
          		$dataRows[] = $row['swap_id'];
          		$dataRows[] = $row['segment_id'];
          		$dataRows[] = $row['contract_type'];
          		$dataRows[] = $row['contract_style'];
          		$dataRows[] = $row['start_date'];
          		$dataRows[] = $row['maturity'];
          		$dataRows[] = $row['clean_dirty'];
          		$dataRows[] = $row['quotation'];
          		$dataRows[] = $row['currency'];
          		$dataRows[] = $row['notional'];
          		$dataRows[] = $row['notional_factor'];
          		$dataRows[] = $row['number_of_units'];
          		$dataRows[] = $row['sro_isin'];
          		$dataRows[] = $row['underlying_isin'];
          		$dataRows[] = $row['seniority'];
          		$dataRows[] = $row['six_telekurs_id'];
          		$dataRows[] = $row['bloomberg_id_1'];
          		$dataRows[] = $row['bloomberg_key'];
          		$dataRows[] = $row['reuters_ric'];
          		$dataRows[] = $row['redpaircode'];
          		$dataRows[] = $row['cusip'];
          		$dataRows[] = $row['spread_id'];
          		$dataRows[] = $row['product_type'];
          		$dataRows[] = $row['currency_underlying'];
          		$dataRows[] = $row['dealspread'];
          		$dataRows[] = $row['usanz'];
          		$dataRows[] = $row['skadenz'];
          		$dataRows[] = $row['recovery_rate'];
          		$dataRows[] = $row['fix_recovery_rate'];
          		$dataRows[] = $row['linked_swap_id'];
          		$dataRows[] = $row['cds_attachment'];
          		$dataRows[] = $row['cds_detachment'];
          		$dataRows[] = $row['credit_events'];
          		$dataRows[] = $row['implied_loss'];
          		$dataRows[] = $row['sector'];
          		$dataRows[] = $row['subsector'];
          		$dataRows[] = $row['rating'];
          		$dataRows[] = $row['start_date_leg_1'];
          		$dataRows[] = $row['notional_leg_1'];
          		$dataRows[] = $row['currency_leg_1'];
          		$dataRows[] = $row['contract_style_leg_1'];
          		$dataRows[] = $row['coupon_leg_1'];
          		$dataRows[] = $row['contract_position_leg_1'];
          		$dataRows[] = $row['quoted_margin_leg_1'];
          		$dataRows[] = $row['usanz_leg_1'];
          		$dataRows[] = $row['reset_skadenz_leg_1'];
          		$dataRows[] = $row['business_day_convention_leg_1'];
          		$dataRows[] = $row['pay_method_leg_1'];
          		$dataRows[] = $row['compounding_leg_1'];
          		$dataRows[] = $row['last_period_leg_1'];
          		$dataRows[] = $row['coupon_date_1st_leg_1'];
          		$dataRows[] = $row['pay_skadenz_leg_1'];
          		$dataRows[] = $row['lag_leg_1'];
          		$dataRows[] = $row['start_date_leg_2'];
          		$dataRows[] = $row['notional_leg_2'];
          		$dataRows[] = $row['currency_leg_2'];
          		$dataRows[] = $row['contract_style_leg_2'];
          		$dataRows[] = $row['coupon_leg_2'];
          		$dataRows[] = $row['contract_position_leg_2'];
          		$dataRows[] = $row['quoted_margin_leg_2'];
          		$dataRows[] = $row['usanz_leg_2'];
          		$dataRows[] = $row['reset_skadenz_leg_2'];
          		$dataRows[] = $row['business_day_convention_leg_2'];
          		$dataRows[] = $row['pay_method_leg_2'];
          		$dataRows[] = $row['compounding_leg_2'];
          		$dataRows[] = $row['last_period_leg_2'];
          		$dataRows[] = $row['coupon_date_1st_leg_2'];
          		$dataRows[] = $row['pay_skadenz_leg_2'];
          		$dataRows[] = $row['lag_leg_2'];
          		$dataRows[] = $row['reset_date'];
          		$dataRows[] = $row['next_reset_date'];
          		$dataRows[] = $row['reset_value'];
          		$dataRows[] = $row['start_index_level'];
          		$dataRows[] = $row['spread'];
          		$dataRows[] = $row['calendar'];
          		$dataRows[] = $row['isda_definition'];
          		$dataRows[] = $row['fx_rate'];
          		$dataRows[] = $row['volatility_strike'];
          		$dataRows[] = $row['volatility_cap'];
          		$dataRows[] = $row['variance_strike'];
          		$dataRows[] = $row['collateral'];
          		$dataRows[] = $row['currency_csa'];
          		$dataRows[] = $row['coupon_1'];
          		$dataRows[] = $row['coupon_2'];
          		$dataRows[] = $row['coupon_3'];
          		$dataRows[] = $row['poolfactor'];
          		$dataRows[] = $row['purchase_rate'];
          		$dataRows[] = $row['purchase_date'];
          		$dataRows[] = $row['coupon_date_2nd'];
          		$dataRows[] = $row['coupon_date_3rd'];
          		$dataRows[] = $row['coupon_date_4th'];
          		$dataRows[] = $row['pay_off_function'];
          		$dataRows[] = $row['counterparty_description'];
          ...
          case "spreads":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['datum'];
              $dataRows[] = $row['sector'];
              $dataRows[] = $row['sector_id'];
              $dataRows[] = $row['subsector'];
              $dataRows[] = $row['subsector_id'];
              $dataRows[] = $row['currency'];
              $dataRows[] = $row['currency_id'];
              $dataRows[] = $row['rating'];
              $dataRows[] = $row['rating_id'];
              $dataRows[] = $row['3M'];
              $dataRows[] = $row['6M'];
              $dataRows[] = $row['1Y'];
              $dataRows[] = $row['2Y'];
          ...
          case "wertpapiere":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['client'];
              $dataRows[] = $row['isin'];
              $dataRows[] = $row['initial_notional'];
              $dataRows[] = $row['issue_currency'];
              $dataRows[] = $row['issue_date'];
              $dataRows[] = $row['effective_date'];
              $dataRows[] = $row['maturity'];
          		$dataRows[] = $row['coupon'];
          		$dataRows[] = $row['z_spread'];
          		$dataRows[] = $row['l_spread'];
          		$dataRows[] = $row['margin'];
          		$dataRows[] = $row['dirty_clean'];
          		$dataRows[] = $row['listing'];
          		$dataRows[] = $row['period'];
          		$dataRows[] = $row['day_count'];
          		$dataRows[] = $row['instrument'];
          		$dataRows[] = $row['security_type'];
          		$dataRows[] = $row['security_type2'];
          		$dataRows[] = $row['sector'];
          		$dataRows[] = $row['subsector'];
          		$dataRows[] = $row['rating'];
          		$dataRows[] = $row['seniority'];
          		$dataRows[] = $row['spread_ticker'];
          		$dataRows[] = $row['poolfactor'];
          		$dataRows[] = $row['security_description'];
          		$dataRows[] = $row['initial_value'];
          		$dataRows[] = $row['closing_date'];
          		$dataRows[] = $row['coupon_date'];
          		$dataRows[] = $row['pay_off'];
          		$dataRows[] = $row['pay_off_method'];
          		$dataRows[] = $row['drowdown_dates'];
          		$dataRows[] = $row['drowdown_notional'];
              $dataRows[] = $row['filename'];
              $dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "optionen":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              $dataRows = array();
              $dataRows[] = $row['id'];
              $dataRows[] = $row['option_id'];
              $dataRows[] = $row['option_currency'];
              $dataRows[] = $row['issue_currency'];
              $dataRows[] = $row['underlying_description'];
              $dataRows[] = $row['underlying_id'];
              $dataRows[] = $row['underlying_dividends'];
              $dataRows[] = $row['contract_type_option'];
              $dataRows[] = $row['options_type'];
              $dataRows[] = $row['option_style'];
              $dataRows[] = $row['strike'];
              $dataRows[] = $row['settle_date_option'];
              $dataRows[] = $row['maturity_option'];
              $dataRows[] = $row['security_type'];
              $dataRows[] = $row['start_date_swap'];
              $dataRows[] = $row['maturity_swap'];
              $dataRows[] = $row['contract_type_swap'];
              $dataRows[] = $row['day_count_swap_leg1'];
              $dataRows[] = $row['spread_swap_leg1'];
              $dataRows[] = $row['period_swap_leg2'];
              $dataRows[] = $row['day_count_swap_leg2'];
              $dataRows[] = $row['spread_swap_leg2'];
              $dataRows[] = $row['contract_size'];
              $dataRows[] = $row['quotation'];
              $dataRows[] = $row['barrier_type'];
              $dataRows[] = $row['barrier_direction'];
              $dataRows[] = $row['barrier_1'];
              $dataRows[] = $row['barrier_2'];
              $dataRows[] = $row['window_start_date'];
              $dataRows[] = $row['barrier_hit_date_1'];
              $dataRows[] = $row['barrier_hit_date_2'];
              $dataRows[] = $row['rebate1'];
              $dataRows[] = $row['rebate2'];
              $dataRows[] = $row['trade_date_2'];
              $dataRows[] = $row['trade_price'];
              $dataRows[] = $row['counter_party'];
              $dataRows[] = $row['filename'];
              $dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "EQSWAPE16X":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['id'];
              $dataRows[] = $row['client'];
              $dataRows[] = $row['AccountNumber'];
              $dataRows[] = $row['AsOfDate'];
              $dataRows[] = $row['AccountName'];
              $dataRows[] = $row['SwapAccountNumber'];
              $dataRows[] = $row['SwapAccountName'];
              $dataRows[] = $row['SwapNumber'];
              $dataRows[] = $row['BasketId'];
              $dataRows[] = $row['BasketCurrency'];
              $dataRows[] = $row['SwapDescription'];
              $dataRows[] = $row['LegType'];
              $dataRows[] = $row['SEDOL'];
              $dataRows[] = $row['Stock'];
              $dataRows[] = $row['Underlyer'];
              $dataRows[] = $row['CUSIP'];
              $dataRows[] = $row['StockDescription'];
              $dataRows[] = $row['TradeDate'];
              $dataRows[] = $row['EffectiveDate'];
              $dataRows[] = $row['ListingCcy'];
              $dataRows[] = $row['SwapSettlementCurrency'];
              $dataRows[] = $row['OpenQuantity'];
              $dataRows[] = $row['AveragePrice'];
              $dataRows[] = $row['Notional'];
              $dataRows[] = $row['MarkPrice'];
              $dataRows[] = $row['MarkFX'];
              $dataRows[] = $row['MarkNotional'];
              $dataRows[] = $row['Performance'];
              $dataRows[] = $row['PendingPerformance'];
              $dataRows[] = $row['Spread'];
              $dataRows[] = $row['Rate'];
              $dataRows[] = $row['TotalRate'];
              $dataRows[] = $row['DayCount'];
              $dataRows[] = $row['Interest'];
              $dataRows[] = $row['PendingInterest'];
              $dataRows[] = $row['Dividend'];
              $dataRows[] = $row['PendingDividend'];
              $dataRows[] = $row['DividendCurrency'];
              $dataRows[] = $row['DiscreteFee'];
              $dataRows[] = $row['FeeCurrency'];
              $dataRows[] = $row['MTMTotal'];
              $dataRows[] = $row['MTMTotalBase'];
              $dataRows[] = $row['Price'];
              $dataRows[] = $row['Quantity'];
              $dataRows[] = $row['Short'];
              $dataRows[] = $row['SwapSettleCurrencyLong'];
              $dataRows[] = $row['MaturityDate'];
              $dataRows[] = $row['IssueType'];
              $dataRows[] = $row['ISIN'];
              $dataRows[] = $row['RICCode'];
              $dataRows[] = $row['RestrictedQuantity'];
              $dataRows[] = $row['TradableQty'];
              $dataRows[] = $row['NumberOfContracts_Qty'];
              $dataRows[] = $row['ContractSize'];
              $dataRows[] = $row['RestrictedFlag'];
              $dataRows[] = $row['MTMTotal_Exposure'];
              $dataRows[] = $row['Long_Short'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "EQSWAPE18MDX":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['CUSIP'];
              $dataRows[] = $row['StockDescription'];
              $dataRows[] = $row['StartDate'];
              $dataRows[] = $row['EndDate'];
              $dataRows[] = $row['ValueDate'];
              $dataRows[] = $row['Price'];
              $dataRows[] = $row['QuantityDP'];
              $dataRows[] = $row['Quantity'];
              $dataRows[] = $row['ListingMarkPrice1'];
              $dataRows[] = $row['MarkFX1'];
              $dataRows[] = $row['MarkPrice1'];
              $dataRows[] = $row['MarkEquityNotional1'];
              $dataRows[] = $row['ListingMarkPrice2'];
              $dataRows[] = $row['MarkFX2'];
              $dataRows[] = $row['MarkPrice2'];
              $dataRows[] = $row['MarkEquityNotional2'];
              $dataRows[] = $row['PerformanceAmount'];
              $dataRows[] = $row['MarkFinNotional'];
              $dataRows[] = $row['DayCount'];
              $dataRows[] = $row['Basis'];
              $dataRows[] = $row['GrossRate'];
              $dataRows[] = $row['Spread'];
              $dataRows[] = $row['NetRate'];
              $dataRows[] = $row['InterestAmount'];
              $dataRows[] = $row['Dividend'];
              $dataRows[] = $row['DividendCurrency'];
              $dataRows[] = $row['Fee'];
              $dataRows[] = $row['FeeCurrency'];
              ...
              $dataRows[] = $row['RICCode'];
              $dataRows[] = $row['ISIN'];
              $dataRows[] = $row['CountryOfIssue'];
              $dataRows[] = $row['IssueType'];
              $dataRows[] = $row['ISODomicile'];
              $dataRows[] = $row['Divisor'];
              $dataRows[] = $row['ContractSize'];
              $dataRows[] = $row['MTMTotalBase'];
              $dataRows[] = $row['Event'];
              $dataRows[] = $row['DividendEvent'];
              $dataRows[] = $row['RealisedInterestNonLocal'];
              $dataRows[] = $row['Unwind_ResetFXFIN'];
              $dataRows[] = $row['RealisedPerformanceNonLocal'];
              $dataRows[] = $row['Unwind_ResetFXEQ'];
              $dataRows[] = $row['TaxAmount'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "EQSWAPE20MDX":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['TradeDate'];
              $dataRows[] = $row['Event'];
              $dataRows[] = $row['PamountLEQ'];
              $dataRows[] = $row['PamountLFI'];
              $dataRows[] = $row['PamountLDV'];
              $dataRows[] = $row['PamountLEE'];
              $dataRows[] = $row['PamountSEQ'];
              $dataRows[] = $row['PamountSFI'];
              $dataRows[] = $row['PamountSDV'];
              $dataRows[] = $row['PamountLSEE'];
              $dataRows[] = $row['SettleDate'];
              $dataRows[] = $row['SettleCurrency'];
              $dataRows[] = $row['TotalAmount'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "EQSWAPE35AX":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['AccountNumber'];
              $dataRows[] = $row['AccountName'];
              $dataRows[] = $row['SwapCurrency'];
              $dataRows[] = $row['SwapNumber'];
              $dataRows[] = $row['BasketDescription'];
              $dataRows[] = $row['BasketId'];
              $dataRows[] = $row['Security'];
              $dataRows[] = $row['ExchangeId'];
              $dataRows[] = $row['CUSIP'];
              $dataRows[] = $row['SEDOL'];
              $dataRows[] = $row['DividendCurrency'];
              $dataRows[] = $row['RecordDate'];
              $dataRows[] = $row['ExDate'];
              $dataRows[] = $row['PayDate'];
              $dataRows[] = $row['GrossDividendPerShare'];
              $dataRows[] = $row['Quantity'];
              $dataRows[] = $row['DividendEntitlementPercent'];
              $dataRows[] = $row['Dividend'];
              $dataRows[] = $row['DividendFxRate'];
              $dataRows[] = $row['RealizedQuantity'];
              $dataRows[] = $row['Event'];
              $dataRows[] = $row['DividendPaymentCurrency'];
              $dataRows[] = $row['RealizedDividend'];
              $dataRows[] = $row['RealizedDividendValueDate'];
              $dataRows[] = $row['RICCode'];
              $dataRows[] = $row['ISIN'];
              $dataRows[] = $row['ListingCurrency'];
              $dataRows[] = $row['CountryOfIssue'];
              $dataRows[] = $row['IssueType'];
              $dataRows[] = $row['Divisor'];
              $dataRows[] = $row['ContractSize'];
          ...
          case "EQSWAPE37X":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['SEDOL'];
              $dataRows[] = $row['RICCode'];
              $dataRows[] = $row['IssueCurrency'];
              $dataRows[] = $row['Description'];
              $dataRows[] = $row['Buy_Sell'];
              $dataRows[] = $row['Quantity'];
              $dataRows[] = $row['ExecutionPrice'];
              $dataRows[] = $row['FXRate'];
              $dataRows[] = $row['Commission'];
              $dataRows[] = $row['Embedded'];
              $dataRows[] = $row['NetPrice'];
              $dataRows[] = $row['Spread'];
              $dataRows[] = $row['DividendEntitlementPercentage'];
              $dataRows[] = $row['Cost'];
              $dataRows[] = $row['MdSymbol'];
              $dataRows[] = $row['SecurityId'];
              $dataRows[] = $row['ExchangeId'];
              $dataRows[] = $row['ISIN'];
              $dataRows[] = $row['Quick'];
              $dataRows[] = $row['Valoren'];
              $dataRows[] = $row['ListingCcy'];
              $dataRows[] = $row['CountryOfIssue'];
              $dataRows[] = $row['IssueType'];
              $dataRows[] = $row['ISODomicile'];
              $dataRows[] = $row['Divisor'];
              $dataRows[] = $row['ContractSize'];
              $dataRows[] = $row['TradeReference'];
              $dataRows[] = $row['Sequence'];
              $dataRows[] = $row['SwapAccountName'];
              $dataRows[] = $row['RestrictedPosition'];
              $dataRows[] = $row['NumberOfContracts_Qty'];
              $dataRows[] = $row['SwapDescription'];
              $dataRows[] = $row['CommissionInSwapCurrency'];
              $dataRows[] = $row['Alt_QtyB__S_'];
              $dataRows[] = $row['SwapMaturityDate'];
              $dataRows[] = $row['Strategy'];
              $dataRows[] = $row['AdhocFee'];
              $dataRows[] = $row['USI'];
              $dataRows[] = $row['UTI'];
              $dataRows[] = $row['LotSize'];
              $dataRows[] = $row['ContainerSwapNumber'];
              $dataRows[] = $row['TaxlotGroupID'];
              $dataRows[] = $row['AcquisitionDate'];
              $dataRows[] = $row['TradeSubType'];
              $dataRows[] = $row['FloatingRateIndex'];
              $dataRows[] = $row['Open_Close'];
              $dataRows[] = $row['Long_Short'];
              $dataRows[] = $row['ExecutingBroker'];
              $dataRows[] = $row['PayToHold'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "EQSWAPE40X":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              ...
              $dataRows[] = $row['Quantity'];
              $dataRows[] = $row['Notional'];
              $dataRows[] = $row['NotionalChange'];
              $dataRows[] = $row['OpenQuantity'];
              $dataRows[] = $row['DayCount'];
              $dataRows[] = $row['Spread'];
              $dataRows[] = $row['Rate'];
              $dataRows[] = $row['Interest'];
              $dataRows[] = $row['RealizedInterest'];
              $dataRows[] = $row['RealizedInterestValueDate'];
              $dataRows[] = $row['VarTIP'];
              $dataRows[] = $row['RICCode'];
              $dataRows[] = $row['SecurityId'];
              $dataRows[] = $row['ExchangeId'];
              ...
              $dataRows[] = $row['ContractSize'];
              $dataRows[] = $row['SwapSettlementCurrency'];
              $dataRows[] = $row['InterestRateConvention'];
              $dataRows[] = $row['SpreadIn_'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
          ...
          case "kurse":
            while ( $row = $this->statement->fetch( $returnType ) ) {
              $dataRows = array();
              $dataRows[] = $row['id'];
              $dataRows[] = $row['kurse_id'];
              $dataRows[] = $row['datum'];
              $dataRows[] = $row['kurs'];
              $dataRows[] = $row['kurs_dirty'];
              $dataRows[] = $row['currency'];
              $dataRows[] = $row['provider'];
              $dataRows[] = $row['assetklasse'];
              $dataRows[] = $row['difference'];
          		$dataRows[] = $row['filename'];
          		$dataRows[] = $row['filedate'];
          		$dataRows[] = $row['status'];
          		$dataRows[] = $row['db_status'];
  ...
  * @param -
  * @return -
  * @details function to display roles in datatables
  */
  function displayRoles( $status ) {
      try {
          $dbc = new Connector();
          $query = "SELECT * FROM roles";
          $dbc->executeQuery( $query );

          if ( $status === "displayUserRoles" ) {
            $results = $dbc->fetchAllResults( PDO::FETCH_ASSOC );
            echo json_encode( $results );
          } elseif ( $status === 'aktualisieren' ) {
            $results = $dbc->fetchAllResults( PDO::FETCH_ASSOC );
            return ( $results );
          } else {
            $results = $dbc->fetchDataTablesRequest( PDO::FETCH_ASSOC, 'displayRoles' );
            echo json_encode( $results );
          }
          // Logging::Log( $results );
      } catch ( PDOException $exception ) {
  ...
  * @param -
  * @return -
  * @details function to add roles to the database
  */
  function addRole() {
      try {
        if ( isset( $_POST['roleName'], $_POST['checkedPermissions'] ) ) {
          $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
          $role = filter_input( INPUT_POST, 'roleName', FILTER_SANITIZE_STRING );
          $permissions = $_POST['checkedPermissions'];

          $dbc = new Connector();
          $query = "SELECT role_name FROM roles WHERE role_name = '" . $role . "' LIMIT 1";
          $dbc->executeQuery( $query );
          $results = $dbc->fetchMessage( 'addRole' );

          if ( Empty( $results )) {
            // Insert new role in database
            $dbc->executeQuery("INSERT INTO roles (role_name) VALUES ( '" . $role . "' )" );
            $result = $dbc->fetchMessage( '' );

            if ( $result !== 'Erfolgreich hinzugefuegt!' ) {
              $output = "Datenbankfehler: INSERT";
              echo json_encode( $output );
              exit;
            }

            $role_id = $dbc->fetchLastInsertId();

            foreach ( $permissions as $key => $value ) {
              $dbc->executeQuery("INSERT INTO role_perm (role_id, perm_id) VALUES ( '" . $role_id . "', '" . $key . "' )" );
            }
            $results = $dbc->fetchMessage( '' );

            if ( $results === 'Erfolgreich hinzugefuegt!' ) {
              echo json_encode( $results );
            }
          }
  ...
  */
  function getRoles() {
      try {
        if ( $_POST["roleID"] ) {
          $dbc = new Connector();
          $query = "SELECT r.role_id, r.role_name, p.perm_id FROM roles r
                    LEFT JOIN role_perm p ON r.role_id = p.role_id WHERE r.role_id = '" . $_POST["roleID"] . "'";
          $dbc->executeQuery( $query );
          $results = $dbc->fetchAllResults( PDO::FETCH_ASSOC );
          echo json_encode( $results );
        }
  ...
  * @param -
  * @return -
  * @details function to update roles in datatables
  */
  function updateRole() {
    ...
    if ( $u->hasRole( "Admin" ) && $_POST['roleID'] ) {
      $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );

      $dbc = new Connector();
      $query = "UPDATE roles
      SET role_name = '" . $_POST["roleName"] . "'
      WHERE role_id ='" . $_POST["roleID"] . "'";
    }
      try {
    		$dbc->executeQuery( $query );

        if ( $_POST['checkedPermissions'] ) {
          foreach ( $_POST['checkedPermissions'] as $key => $value ) {
            $query = "INSERT INTO role_perm (role_id, perm_id) VALUES('" . $_POST["roleID"] . "', '" . $key . "')
                      ON DUPLICATE KEY UPDATE
                      role_id='" . $_POST["roleID"] . "', perm_id='" . $key . "'";
            $dbc->executeQuery( $query );
            $results = $dbc->fetchMessage( 'updateRole' );
          }
        }
        echo json_encode( $results );
        // Logging::Log($results );
  ...
  */
  function deleteRole() {
      try {
        ...
        if ( $u->hasRole( "Admin" )) {
          $dbc = new Connector();
          $query = "DELETE FROM roles WHERE role_id = " . $_POST["roleID"] . "";
          $dbc->executeQuery( $query );
        }
        // Logging::Log( $results );
      } catch ( PDOException $exception ) {
  ...
  /**
  * @brief function getRoleId()
  * @param $role
  * @return role_id
  * @details fetches the role_id from the database
  */
  function getRoleId( $role) {
    $dbc = new Connector();
    $query = "SELECT role_id FROM roles WHERE role_name = '" . $role . "'";
    $getRoleId = $dbc->executeQuery( $query );
    $role_id = $dbc->fetchResults();
    return $role_id;
  }
  ...
  * @param -
  * @return -
  * @details function to display users from datatables
  */
  function displayUsers() {
      try {
        ...
        $dbc->executeQuery( $query );
        $results = $dbc->fetchDataTablesRequest( PDO::FETCH_ASSOC, 'displayUsers' );
        echo json_encode( $results );
        // Logging::Log( $results );
      } catch ( PDOException $exception ) {
        // Output expected PDOException.
  ...
  */
  function addUser() {
      try {
        if ( isset( $_POST['userName'], $_POST['userEmail'], $_POST['p'] ) ) {
          $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
          ...
          if (!filter_var( $email, FILTER_VALIDATE_EMAIL)) {
            ...
            $error_msg .= 'Die eingegebene Email Adresse ist nicht gültig!';
          ...
          $position = filter_input( INPUT_POST, 'userPosition', FILTER_SANITIZE_STRING );
          ...
          // Username and password were already checkedPermissions  $dbc = new Connector();
          $dbc = new Connector();
          $query = "SELECT user_id FROM users WHERE email = '" . $email . "' LIMIT 1";
          $dbc->executeQuery( $query );
          $results = $dbc->fetchMessage( 'addUser' );
          if ( Empty( $results )) {
            ...
            $query = "INSERT INTO users (username, email, first_name, last_name, position, password, salt, created_at, created_by)
                                                   VALUES ( '" . $username . "', '" . $email . "', '" . $vorname . "', '" . $nachname . "',
                                                           '" . $position . "', '" . $password . "', '" . $random_salt . "', NOW(),
                                                           '" . $_SESSION['username'] . "' )";
            $dbc->executeQuery( $query );
            $results = $dbc->fetchMessage( '' );
            if ( $results === 'Erfolgreich hinzugefuegt!' ) {
               $results = 'Benutzer: ' . $results;
            }

            // adding role to the user
            $user_id = $dbc->fetchLastInsertId();
            $getRole = getRoleId( $role );
            $role_id = $getRole[0]->role_id;
            $query = "INSERT INTO user_role (user_id, role_id) VALUES ( '". $user_id . "', '" . $role_id . "' )";
            $dbc->executeQuery( $query );
            $results .= '<br>Rolle: ' . $dbc->fetchMessage( '' );
  ...
  */
  function getUser() {
      try {
        $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
        if( $_POST["userID"] ) {
          $roles = displayRoles( 'aktualisieren' );
          $dbc = new Connector();
          $query = "SELECT u.user_id, u.username, u.email, u.first_name, u.last_name, u.position, r.role_name FROM users u
                    LEFT JOIN user_role ur ON ur.user_id = u.user_id
                    LEFT JOIN roles r ON ur.role_id = r.role_id
                    WHERE u.user_id = '" . $_POST["userID"]. "'";
          $dbc->executeQuery( $query );
          $result = $dbc->fetchAllResults( PDO::FETCH_ASSOC );
          $results = array_merge( $result,$roles );
          echo json_encode( $results );
        }
        // Logging::Log( $results );
      } catch ( PDOException $exception ) {
  ...
  * @param -
  * @return -
  * @details function to update user in the datatables
  */
  function updateUser() {
      try {
        $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
        ...
        if ( isset( $_POST["userID"] ) ) {
          $dbc = new Connector();
      		$query = "UPDATE users
                 		SET username = '" . $_POST["userName"] . "', first_name = '" . $_POST["userVorname"] . "',
                    last_name = '" . $_POST["userNachname"] . "', position = '" . $_POST["userPosition"] . "',
                    updated_by = '" . $_SESSION["username"] . "' WHERE user_id ='" . $_POST["userID"] . "'";
      		$dbc->executeQuery( $query );
        }

        if ( $_POST['userRole'] && $_POST['userID'] ) {
          $dbc = new Connector();
          $getRole = getRoleId( $_POST['userRole'] );
          $role_id = $getRole[0]->role_id;
      		$query = "UPDATE user_role
                		SET role_id = '" . $role_id . "'
                		WHERE user_id ='" . $_POST["userID"] . "'";
      		$isUpdated = $dbc->executeQuery( $query );
      	}
        // Logging::Log( $results );
      } catch ( PDOException $exception ) {
        // Output expected PDOException.
  ...
  * @param -
  * @return -
  * @details function to delete user from the datatables
  */
  function deleteUser() {
      try {
        include_once( dirname( $_SERVER['DOCUMENT_ROOT'] ) ."/inc/role.inc.php" );
  ...
  */
  function displayUserInformation() {
      try {
        ...
        if ( isset( $_SESSION["user_id"] ) ) {
          $dbc = new Connector();
          $query = "SELECT user_id, username, first_name, last_name, position, email, profile_photo, photo_type FROM users WHERE user_id = '". $_SESSION["user_id"]  . "'";
          $dbc->executeQuery( $query );
          $results = $dbc->fetchInformation( PDO::FETCH_ASSOC, 'displayUserInformation' );
          echo json_encode( $results );
        }
        // Logging::Log( $results );
      } catch ( PDOException $exception ) {
...
/**
* @brief updateProfilePicture()
* @param -
* @return -
* @details function to upload profile picture to the database
*/
function updateProfilePicture() {
    try {
      ...
      if ( $check !== false && isset( $_SESSION["user_id"] ) ) {
        ...
        $dbc = new Connector();
        $query = "UPDATE users SET profile_photo = '". $imgContent  . "', photo_filename = '". $fileName  . "', photo_type = '". $fileType  . "', photo_size = '". $fileSize  . "'
                  WHERE user_id = '". $_SESSION["user_id"]  . "'";
        $dbc->executeQuery( $query );
        $results = $dbc->fetchMessage( 'updateProfilePicture' );
        echo json_encode( $results );
      }
      // Logging::Log( $results );
    } catch ( PDOException $exception ) {
...
/**
* @brief updateUserProfile()
* @param -
* @return -
* @details function to upload profile details of the user to the database
*/
function updateUserProfile() {
    try {
      ...
      $dbc = new Connector();
      $query = "UPDATE users SET username = '". $username  . "', first_name = '". $firstname  . "', last_name = '". $lastname  . "', email = '". $email  . "',
                updated_by = '". $_SESSION["username"]  . "'
                WHERE user_id = '". $_SESSION["user_id"]  . "'";
      $dbc->executeQuery( $query );
      $results = $dbc->fetchMessage( 'updateUserProfile' );
      echo json_encode( $results );
      // Logging::Log( $results );
    } catch ( PDOException $exception ) {
      // Output expected PDOException.
...
* @param -
* @return -
* @details function to load the User Avatar from the database
*/
function loadAvatar() {
    try {
      $dbc = new Connector();
      $query = "SELECT profile_photo, photo_type FROM users WHERE user_id = '" . $_SESSION["user_id"] . "'";
      $dbc->executeQuery( $query );
      $results = $dbc->fetchInformation( PDO::FETCH_ASSOC, 'loadAvatar' );
      echo json_encode( $results );
...
/**
* @brief function updatePW()
* @param -
* @return -
* @details function to updata a user password on the database, after comparing the old one
*/
function updatePW() {
  $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
  $pass1 = $_POST["userPassword"];
  $pass2 = $_POST["conf"];
  $old_password = $_POST["pwAlt"];
  $email = $_POST["email"];
  $user = $_SESSION['username'];

  // If both passwords do not match, an error message will be displayed and we exit the script
  if ( $pass1 != $pass2 ) {
    $error = "Passwort stimmt nicht überein, beide Passwörter sollten gleich sein.";
  }
  ...
  if ( isset( $error ) ) {
    ...
    // compare the old password with the one saved in the database
    $match = comparePW( $email, $old_password );
    ...
    if ( $match ) {
      ...
      $random_salt = hash( 'sha512', uniqid( openssl_random_pseudo_bytes(16), TRUE ) );
      // create a salted password
      $password = hash( 'sha512', $pass1 . $random_salt );
      $timestamp = date( 'Y-m-d H:i:s' );

      $dbc = new Connector();
      $query = "UPDATE `users` SET `password`='" . $password . "', `salt`='" . $random_salt . "', `updated_at`='" . $timestamp . "', `updated_by`='" . $user . "'
                WHERE `email`='" . $email . "'";

      try {
        $dbc->executeQuery( $query );
        echo json_encode( 'Passwort wurde erfolgreich aktualisiert!' );
      ...
      echo json_encode( 'Altes Passwort ist inkorrekt. Bitte versuchen Sie es erneut.' );
      exit;
    }
...
/**
* @brief function comparePW
* @param $email | $passOld = old password of the user
* @return true if the passord matches, else false
* @details function compares the old password, with the one saved in the database
*/
function comparePW( $email, $old_password ) {
  ...
  try {
    ...
    $salt = $results[0]['salt'];
    $old_password = hash( 'sha512', $old_password . $salt );
  ...
  function displayData( $type ) {
      try {
        ...
        if ( $type === 'swaps' ) {
          ...
          $query = "SELECT * FROM devisen AS s";
  ...
  * @param -
  * @return -
  * @details function to get a swap from the database
  */
  function getSwap() {
    $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
    ...
    if( $_POST["id"] ) {
      $dbc = new Connector();
      $query = "SELECT * FROM swaps WHERE id = '" . $_POST["id"]. "'";
  ...
  * @param -
  * @return -
  * @details function to update swap in the database
  */
  function updateSwap() {
    $_POST = filter_input_array( INPUT_POST, FILTER_SANITIZE_STRING );
    ...
    if ( isset( $_POST["id"] ) ) {
      $dbc = new Connector();
      $query = "UPDATE swaps
      SET client = '" . $_POST["client"] . "', swap_id = '" . $_POST["swap_id"] . "',  segment_id = '" . $_POST["segment_id"] . "',
      contract_type = '" . $_POST["contract_type"] . "', contract_style = '" . $_POST["contract_style"] . "', start_date = '" . $_POST["start_date"] . "',
      maturity = '" . $_POST["maturity"] . "', clean_dirty = '" . $_POST["clean_dirty"] . "', quotation = '" . $_POST["quotation"] . "',
      currency = '" . $_POST["currency"] . "', notional = '" . $_POST["notional"] . "', notional_factor = '" . $_POST["notional_factor"] . "',
      number_of_units = '" . $_POST["number_of_units"] . "', sro_isin = '" . $_POST["sro_isin"] . "', underlying_isin = '" . $_POST["underlying_isin"] . "',
      seniority = '" . $_POST["seniority"] . "', six_telekurs_id = '" . $_POST["six_telekurs_id"] . "', bloomberg_id_1 = '" . $_POST["bloomberg_id_1"] . "',
      bloomberg_key = '" . $_POST["bloomberg_key"] . "', reuters_ric = '" . $_POST["reuters_ric"] . "', redpaircode = '" . $_POST["redpaircode"] . "',
      cusip = '" . $_POST["cusip"] . "', spread_id = '" . $_POST["spread_id"] . "', product_type = '" . $_POST["product_type"] . "',
      currency_underlying = '" . $_POST["currency_underlying"] . "', dealspread = '" . $_POST["dealspread"] . "', usanz = '" . $_POST["usanz"] . "',
      skadenz = '" . $_POST["skadenz"] . "', recovery_rate = '" . $_POST["recovery_rate"] . "', fix_recovery_rate = '" . $_POST["fix_recovery_rate"] . "',
      linked_swap_id = '" . $_POST["linked_swap_id"] . "', cds_attachment = '" . $_POST["cds_attachment"] . "', cds_detachment = '" . $_POST["cds_detachment"] . "',
      credit_events = '" . $_POST["credit_events"] . "', implied_loss = '" . $_POST["implied_loss"] . "', sector = '" . $_POST["sector"] . "',
      subsector = '" . $_POST["subsector"] . "', rating = '" . $_POST["rating"] . "', start_date_leg_1 = '" . $_POST["start_date_leg_1"] . "',
      notional_leg_1 = '" . $_POST["notional_leg_1"] . "', currency_leg_1 = '" . $_POST["currency_leg_1"] . "', contract_style_leg_1 = '" . $_POST["contract_style_leg_1"] . "',
      coupon_leg_1 = '" . $_POST["coupon_leg_1"] . "', contract_position_leg_1 = '" . $_POST["contract_position_leg_1"] . "', quoted_margin_leg_1 = '" . $_POST["quoted_margin_leg_1"] . "',
      usanz_leg_1 = '" . $_POST["usanz_leg_1"] . "', reset_skadenz_leg_1 = '" . $_POST["reset_skadenz_leg_1"] . "', business_day_convention_leg_1 = '" . $_POST["business_day_convention_leg_1"] . "',
      pay_method_leg_1 = '" . $_POST["pay_method_leg_1"] . "', compounding_leg_1 = '" . $_POST["compounding_leg_1"] . "', last_period_leg_1 = '" . $_POST["last_period_leg_1"] . "',
      coupon_date_1st_leg_1 = '" . $_POST["coupon_date_1st_leg_1"] . "', pay_skadenz_leg_1 = '" . $_POST["pay_skadenz_leg_1"] . "', lag_leg_1 = '" . $_POST["lag_leg_1"] . "',
      start_date_leg_2 = '" . $_POST["start_date_leg_2"] . "', notional_leg_2 = '" . $_POST["notional_leg_2"] . "', currency_leg_2 = '" . $_POST["currency_leg_2"] . "',
      contract_style_leg_2 = '" . $_POST["contract_style_leg_2"] . "', coupon_leg_2 = '" . $_POST["coupon_leg_2"] . "', contract_position_leg_2 = '" . $_POST["contract_position_leg_2"] . "',
      quoted_margin_leg_2 = '" . $_POST["quoted_margin_leg_2"] . "', usanz_leg_2 = '" . $_POST["usanz_leg_2"] . "', reset_skadenz_leg_2 = '" . $_POST["reset_skadenz_leg_2"] . "',
      business_day_convention_leg_2 = '" . $_POST["business_day_convention_leg_2"] . "', pay_method_leg_2 = '" . $_POST["pay_method_leg_2"] . "', compounding_leg_2 = '" . $_POST["compounding_leg_2"] . "',
      last_period_leg_2 = '" . $_POST["last_period_leg_2"] . "', coupon_date_1st_leg_2 = '" . $_POST["coupon_date_1st_leg_2"] . "', pay_skadenz_leg_2 = '" . $_POST["pay_skadenz_leg_2"] . "',
      lag_leg_2 = '" . $_POST["lag_leg_2"] . "', reset_date = '" . $_POST["reset_date"] . "', next_reset_date = '" . $_POST["next_reset_date"] . "',
      reset_value = '" . $_POST["reset_value"] . "', start_index_level = '" . $_POST["start_index_level"] . "', spread = '" . $_POST["spread"] . "',
      calendar = '" . $_POST["calendar"] . "', isda_definition = '" . $_POST["isda_definition"] . "', fx_rate = '" . $_POST["fx_rate"] . "',
      volatility_strike = '" . $_POST["volatility_strike"] . "', volatility_cap = '" . $_POST["volatility_cap"] . "', variance_strike = '" . $_POST["variance_strike"] . "',
      collateral = '" . $_POST["collateral"] . "', currency_csa = '" . $_POST["currency_csa"] . "', coupon_1 = '" . $_POST["coupon_1"] . "',
      coupon_2 = '" . $_POST["coupon_2"] . "', coupon_3 = '" . $_POST["coupon_3"] . "', poolfactor = '" . $_POST["poolfactor"] . "',
      purchase_rate = '" . $_POST["purchase_rate"] . "', purchase_date = '" . $_POST["purchase_date"] . "', coupon_date_2nd = '" . $_POST["coupon_date_2nd"] . "',
      coupon_date_3rd = '" . $_POST["coupon_date_3rd"] . "', coupon_date_4th = '" . $_POST["coupon_date_4th"] . "', pay_off_function = '" . $_POST["pay_off_function"] . "',
      counterparty_description = '" . $_POST["counterparty_description"] . "', filename = '" . $_POST["filename"] . "', filedate = '" . $_POST["filedate"] . "', status = '" . $_POST["status"] . "',
      updated_by = '" . $_SESSION['username'] . "' WHERE id ='" . $_POST["id"] . "'";
  ...
  * @param -
  * @return -
  * @details function to delete swap from the datatables
  */
  function deleteSwap() {
    ...
    if ( $u->hasRole( "Admin" ) || $u->hasRole( "Manager" ) ) {
      ...
      $query = "DELETE FROM swaps WHERE id = " . $_POST["id"] . "";
   ...
   function extractFileData( $filename, $mapping, $anz, $index ) {
     ...
     if ( $anz > 1 ) {
       if ( $fileExtension === 'xls' || $fileExtension === 'xlsx' ) {
         ...
         $targetPath = $_SERVER['DOCUMENT_ROOT'] . '/files/market/csv/' . $filename;
       }
       // below is the one used for docker container
       // $targetPath = $_SERVER['DOCUMENT_ROOT'] . 'files/market/excel/' . $filename;
     } else {
  ...
  function loadData() {
    ...
    for ( $c=0; $c < $anz; $c++ ) {
      ...
      for ( $i = 0; $i < count( $transformedData[$c] ) ; $i++ ) {
        ...
        try {
          $query = $q . '( ' . implode( ',', $insertInto ) . ',`filename`,`filedate`,`db_status`,`created_by` ) VALUES ( ' . implode( ',', $insertValues ) . ', "' . $filename . '", "' . $filedate . '", "INSERT", "' . $_SESSION["username"] . '" )';
          $log_query = $log . '( ' . implode( ',', $insertInto ) . ',`filename`,`filedate`,`db_status`,`created_by` ) VALUES ( ' . implode( ',', $insertValues ) . ', "' . $filename . '", "' . $filedate . '", "INSERT", "' . $_SESSION["username"] . '" )';
          $query = $query . ' ON DUPLICATE KEY UPDATE ' . implode( ',', $duplicateKeyUpdate ) . ", `filename` = '" . $filename . "', `filedate` = '" . $filedate . "', `db_status` = 'UPDATE', `updated_at` = NOW(), `updated_by` = '" . $_SESSION["username"] . "'";
   ...
   */
    ...
    */
    function getDevisen() {
      ...
      if ( $_POST["id"]) {
        $dbc = new Connector();
        $query = "SELECT * FROM devisen WHERE id = '" . $_POST["id"] . "'";
